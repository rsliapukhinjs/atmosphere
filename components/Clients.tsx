...
import progress from "../public/clients/progress.png";
...
import alcopack from "../public/clients/alcopack.png";

const Clients = () => {
  return (
    <section className="hidden md:flex flex-col items-center gap-8 p-8 text-sky-800 bg-slate-50">
