...
const Footer = () => {
  return (
    <footer className="bg-teal-800 text-teal-50 flex flex-col items-center justify-center text-sm">
      <div className="w-full p-8 px-16 lg:px-32 flex lg:grid grid-cols-4 text-xs uppercase">
      ...
      <div className="w-full p-4 border-t-2 flex items-center justify-center bg-sky-800">
